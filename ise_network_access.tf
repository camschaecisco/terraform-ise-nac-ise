...
resource "ise_network_access_condition" "network_access_condition" {
  ...
  children = [for c in try(each.value.children, []) : {
    ...
    children = [for c2 in try(c.children, []) : {
      ...
      children = [for c3 in try(c2.children, []) : {
        attribute_name   = strcontains(try(c3.attribute_name, local.defaults.ise.network_access.policy_elements.conditions.attribute_name, ""), ":") ? split(":", try(c3.attribute_name, local.defaults.ise.network_access.policy_elements.conditions.attribute_name, null))[1] : try(c3.attribute_name, local.defaults.ise.network_access.policy_elements.conditions.attribute_name, null)
        attribute_value  = strcontains(try(c3.attribute_value, local.defaults.ise.network_access.policy_elements.conditions.attribute_value, ""), ":") ? split(":", try(c3.attribute_value, local.defaults.ise.network_access.policy_elements.conditions.attribute_value, null))[1] : try(c3.attribute_value, local.defaults.ise.network_access.policy_elements.conditions.attribute_value, null)
        dictionary_name  = strcontains(try(c3.attribute_name, local.defaults.ise.network_access.policy_elements.conditions.attribute_name, ""), ":") ? split(":", try(c3.attribute_name, local.defaults.ise.network_access.policy_elements.conditions.attribute_name, null))[0] : null
        dictionary_value = strcontains(try(c3.attribute_value, local.defaults.ise.network_access.policy_elements.conditions.attribute_value, ""), ":") ? split(":", try(c3.attribute_value, local.defaults.ise.network_access.policy_elements.conditions.attribute_value, null))[0] : null
        ...
        children = [for c4 in try(c3.children, []) : {
          attribute_name   = strcontains(try(c4.attribute_name, local.defaults.ise.network_access.policy_elements.conditions.attribute_name, ""), ":") ? split(":", try(c4.attribute_name, local.defaults.ise.network_access.policy_elements.conditions.attribute_name, null))[1] : try(c4.attribute_name, local.defaults.ise.network_access.policy_elements.conditions.attribute_name, null)
          attribute_value  = strcontains(try(c4.attribute_value, local.defaults.ise.network_access.policy_elements.conditions.attribute_value, ""), ":") ? split(":", try(c4.attribute_value, local.defaults.ise.network_access.policy_elements.conditions.attribute_value, null))[1] : try(c4.attribute_value, local.defaults.ise.network_access.policy_elements.conditions.attribute_value, null)
          dictionary_name  = strcontains(try(c4.attribute_name, local.defaults.ise.network_access.policy_elements.conditions.attribute_name, ""), ":") ? split(":", try(c4.attribute_name, local.defaults.ise.network_access.policy_elements.conditions.attribute_name, null))[0] : null
          dictionary_value = strcontains(try(c4.attribute_value, local.defaults.ise.network_access.policy_elements.conditions.attribute_value, ""), ":") ? split(":", try(c4.attribute_value, local.defaults.ise.network_access.policy_elements.conditions.attribute_value, null))[0] : null
  ...
  network_access_policy_sets = [
    for ps in try(local.ise.network_access.policy_sets, []) : {
      ...
      children = try([for i in ps.condition.children : {
        ...
        dictionary_name  = strcontains(try(i.attribute_name, local.defaults.ise.network_access.policy_sets.condition.attribute_name, ""), ":") ? split(":", try(i.attribute_name, local.defaults.ise.network_access.policy_sets.condition.attribute_name, null))[0] : try(i.dictionary_name, null)
        ...
        children = try([for j in i.children : {
          ...
          dictionary_name  = strcontains(try(j.attribute_name, local.defaults.ise.network_access.policy_sets.condition.attribute_name, ""), ":") ? split(":", try(j.attribute_name, local.defaults.ise.network_access.policy_sets.condition.attribute_name, null))[0] : try(j.dictionary_name, null)
          ...
          children = try([for k in j.children : {
            ...
            attribute_value  = strcontains(try(k.attribute_value, local.defaults.ise.network_access.policy_sets.condition.attribute_value, ""), ":") ? split(":", try(k.attribute_value, local.defaults.ise.network_access.policy_sets.condition.attribute_value, null))[1] : try(k.attribute_value, local.defaults.ise.network_access.policy_sets.condition.attribute_value, null)
            dictionary_name  = strcontains(try(k.attribute_name, local.defaults.ise.network_access.policy_sets.condition.attribute_name, ""), ":") ? split(":", try(k.attribute_name, local.defaults.ise.network_access.policy_sets.condition.attribute_name, null))[0] : try(k.dictionary_name, null)
            dictionary_value = strcontains(try(k.attribute_value, local.defaults.ise.network_access.policy_sets.condition.attribute_value, ""), ":") ? split(":", try(k.attribute_value, local.defaults.ise.network_access.policy_sets.condition.attribute_value, null))[0] : null
            ...
            children = try([for l in k.children : {
              ...
              attribute_value  = strcontains(try(l.attribute_value, local.defaults.ise.network_access.policy_sets.condition.attribute_value, ""), ":") ? split(":", try(l.attribute_value, local.defaults.ise.network_access.policy_sets.condition.attribute_value, null))[1] : try(l.attribute_value, local.defaults.ise.network_access.policy_sets.condition.attribute_value, null)
              dictionary_name  = strcontains(try(l.attribute_name, local.defaults.ise.network_access.policy_sets.condition.attribute_name, ""), ":") ? split(":", try(l.attribute_name, local.defaults.ise.network_access.policy_sets.condition.attribute_name, null))[0] : try(l.dictionary_name, null)
              dictionary_value = strcontains(try(l.attribute_value, local.defaults.ise.network_access.policy_sets.condition.attribute_value, ""), ":") ? split(":", try(l.attribute_value, local.defaults.ise.network_access.policy_sets.condition.attribute_value, null))[0] : null
    ...
    for ps in try(local.ise.network_access.policy_sets, []) : [
      for rule in try(ps.authentication_rules, []) : {
        ...
        children = try([for i in rule.condition.children : {
          ...
          dictionary_name  = strcontains(try(i.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, ""), ":") ? split(":", try(i.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, null))[0] : try(i.dictionary_name, null)
          ...
          children = try([for j in i.children : {
            ...
            dictionary_name  = strcontains(try(j.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, ""), ":") ? split(":", try(j.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, null))[0] : try(j.dictionary_name, null)
            ...
            children = try([for k in j.children : {
              attribute_name   = strcontains(try(k.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, ""), ":") ? split(":", try(k.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, null))[1] : try(k.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, null)
              attribute_value  = strcontains(try(k.attribute_value, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_value, ""), ":") ? split(":", try(k.attribute_value, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_value, null))[1] : try(k.attribute_value, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_value, null)
              dictionary_name  = strcontains(try(k.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, ""), ":") ? split(":", try(k.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, null))[0] : try(k.dictionary_name, null)
              dictionary_value = strcontains(try(k.attribute_value, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_value, ""), ":") ? split(":", try(k.attribute_value, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_value, null))[0] : null
              ...
              children = try([for l in k.children : {
                attribute_name   = strcontains(try(l.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, ""), ":") ? split(":", try(l.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, null))[1] : try(l.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, null)
                attribute_value  = strcontains(try(l.attribute_value, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_value, ""), ":") ? split(":", try(l.attribute_value, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_value, null))[1] : try(l.attribute_value, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_value, null)
                dictionary_name  = strcontains(try(l.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, ""), ":") ? split(":", try(l.attribute_name, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_name, null))[0] : try(l.dictionary_name, null)
                dictionary_value = strcontains(try(l.attribute_value, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_value, ""), ":") ? split(":", try(l.attribute_value, local.defaults.ise.network_access.policy_sets.authentication_rules.condition.attribute_value, null))[0] : null
      ...
      for rule in try(ps.authorization_exception_rules, []) : {
        ...
        children = try([for i in rule.condition.children : {
          ...
          children = try([for j in i.children : {
            ...
            children = try([for k in j.children : {
              attribute_name   = strcontains(try(k.attribute_name, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_name, ""), ":") ? split(":", try(k.attribute_name, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_name, null))[1] : try(k.attribute_name, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_name, null)
              attribute_value  = strcontains(try(k.attribute_value, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_value, ""), ":") ? split(":", try(k.attribute_value, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_value, null))[1] : try(k.attribute_value, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_value, null)
              dictionary_name  = strcontains(try(k.attribute_name, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_name, ""), ":") ? split(":", try(k.attribute_name, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_name, null))[0] : try(k.dictionary_name, null)
              dictionary_value = strcontains(try(k.attribute_value, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_value, ""), ":") ? split(":", try(k.attribute_value, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_value, null))[0] : null
              ...
              children = try([for l in k.children : {
                attribute_name   = strcontains(try(l.attribute_name, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_name, ""), ":") ? split(":", try(l.attribute_name, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_name, null))[1] : try(l.attribute_name, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_name, null)
                attribute_value  = strcontains(try(l.attribute_value, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_value, ""), ":") ? split(":", try(l.attribute_value, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_value, null))[1] : try(l.attribute_value, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_value, null)
                dictionary_name  = strcontains(try(l.attribute_name, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_name, ""), ":") ? split(":", try(l.attribute_name, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_name, null))[0] : try(l.dictionary_name, null)
                dictionary_value = strcontains(try(l.attribute_value, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_value, ""), ":") ? split(":", try(l.attribute_value, local.defaults.ise.network_access.policy_sets.authorization_exception_rules.condition.attribute_value, null))[0] : null
      ...
      children = try([for i in rule.condition.children : {
        ...
        children = try([for j in i.children : {
          ...
          children = try([for k in j.children : {
            ...
            attribute_value  = strcontains(try(k.attribute_value, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_value, ""), ":") ? split(":", try(k.attribute_value, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_value, null))[1] : try(k.attribute_value, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_value, null)
            dictionary_name  = strcontains(try(k.attribute_name, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_name, ""), ":") ? split(":", try(k.attribute_name, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_name, null))[0] : try(k.dictionary_name, null)
            dictionary_value = strcontains(try(k.attribute_value, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_value, ""), ":") ? split(":", try(k.attribute_value, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_value, null))[0] : null
            ...
            children = try([for l in k.children : {
              ...
              attribute_value  = strcontains(try(l.attribute_value, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_value, ""), ":") ? split(":", try(l.attribute_value, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_value, null))[1] : try(l.attribute_value, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_value, null)
              dictionary_name  = strcontains(try(l.attribute_name, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_name, ""), ":") ? split(":", try(l.attribute_name, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_name, null))[0] : try(l.dictionary_name, null)
              dictionary_value = strcontains(try(l.attribute_value, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_value, ""), ":") ? split(":", try(l.attribute_value, local.defaults.ise.network_access.authorization_global_exception_rules.condition.attribute_value, null))[0] : null
