locals {
  ...
  network_access_conditions           = try({ for condition in local.ise.policy.policy_elements.network_access_conditions : condition.name => condition }, {})
  ...
  authorization_profiles              = try({ for profile in local.ise.policy.policy_elements.authorization_profiles : profile.name => profile }, {})
  allowed_protocols                   = try({ for protocol in local.ise.policy.policy_elements.allowed_protocols : protocol.name => protocol }, {})
