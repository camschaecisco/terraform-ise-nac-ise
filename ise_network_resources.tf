...
resource "ise_network_device" "network_device" {
  ...
  snmp_originating_policy_service_node                        = try(each.value.snmp.ro_community, local.defaults.ise.network_resources.network_devices.snmp.ro_community, null) != null ? try(each.value.snmp.originating_policy_service_node, local.defaults.ise.network_resources.network_devices.snmp.originating_policy_service_node, null) : null
